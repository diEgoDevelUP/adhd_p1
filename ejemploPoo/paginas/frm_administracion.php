    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col col-4">
                ...
                <form action="../objetos/objeto_administracion.php" method="get">
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" id="txtBonificacion" name="txtBonificacion" class="form-control" placeholder="Ingrese su bonificacion">
                    </div>
                    <div class="mb-3">
